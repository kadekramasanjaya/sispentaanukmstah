...
<head>
    ...
    <title>DASHBOARD - UKM BAHASA INGGRIS</title>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('ukmbahasainggris/') }}/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
...
<body>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('ukmbahasainggris/') }}/assets/vendor/jquery/jquery.min.js"></script>
    ...
    <script src="{{ asset('ukmbahasainggris/') }}/assets/js/main.js"></script>
