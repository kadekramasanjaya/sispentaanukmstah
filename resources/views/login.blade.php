...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('dashboardadmin/') }}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{ asset('dashboardadmin/') }}/index2.html" class="h1"><b>ADMIN</b><br>SISPENTAAN</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">STAH N MPU KUTURAN SINGARAJA</p>
